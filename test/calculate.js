...
describe('Test1 for calculator', function() {
    ...
    it('check1', function() {
        ...
        expect(JSON.parse(s).display).to.eql('1');
    });
    ...
    it('check4', function() {
        ...
        expect(JSON.parse(s).display).to.eql('4');
    });
    
    it('check5', function() {
        s = calculator.calculateNextState(s, "3");
        expect(JSON.parse(s).display).to.eql('43');
    });

    it('check6', function() {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql('55');
    });
    ...
    it('check9', function() {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql('56');
    });
    
    it('check10', function() {
        s = calculator.calculateNextState(s, "5");
        expect(JSON.parse(s).display).to.eql('5');
    });
    
    it('check11', function() {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql('6');
    });
});
...
describe('Test2 for calculator', function() {
    ...
    it('check12', function() {
        s = calculator.calculateNextState(s, "+");
        expect(JSON.parse(s).display).to.eql('0');
    });
...
describe('Test3 for calculator', function() {
    ...
    it('check20', async () => {
        s = calculator.calculateNextState(s, "2");
        expect(JSON.parse(s).display).to.eql('2');
    });
   
    it('check21', async () => {
        s = calculator.calculateNextState(s, "2");
        expect(JSON.parse(s).display).to.eql('22');
    });
...
describe('Test4 for calculator', function() {
    ...
    it('check30', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("144");
    });
});
...
describe('Test6 for calculator', function() {
    ...
    it('check43', async () => {
        ...
        expect(JSON.parse(s).display).to.eql("20");
    });
    
    it('check44', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("-100");
    });
});
describe('Test7 for calculator', function() {
    ...
    it('check45', async () => {
        s = calculator.calculateNextState(s, "3");
        expect(JSON.parse(s).display).to.eql("3");
    });
    
    it('check46', async () => {
        s = calculator.calculateNextState(s, "0");
        expect(JSON.parse(s).display).to.eql("30");
    });
    ...
    it('check49', async () => {
        s = calculator.calculateNextState(s, "/");
        expect(JSON.parse(s).display).to.eql("25");
    });
    ...
    it('check54', async () => {
        ...
        expect(JSON.parse(s).display).to.eql("8");
    });
   
    it('check55', async () => { 
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("16");
    });
});
describe('Test8 for calculator', function() {
    ...
    it('check60', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("18");
    });
});
...
describe('Test10 for calculator', function() {
    ...
    it('check67', async () => {
        s = calculator.calculateNextState(s, "0");
        expect(JSON.parse(s).display).to.eql("40");
    });
    ...
    it('check70', async () => {
        s = calculator.calculateNextState(s, "0");
        expect(JSON.parse(s).display).to.eql("10");
    });
    
    it('check71', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("400");
    });
   
    it('check72', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("4000");
    });
   
    it('check73', async () => {
        s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("40000");
    });
});
describe('Test11 for calculator', function() {
    ...
    it('check81', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("7");
    });
});
describe('Test12 for calculator', function() {
    ...
    it('check82', async () => {
        ...
        expect(JSON.parse(s).display).to.eql("9");
    });
    
    it('check83', async () => {
		s = calculator.calculateNextState(s, "3");
        expect(JSON.parse(s).display).to.eql("93");
    });
...
describe('Test14 for calculator', function() {
    ...
    it('check103', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("21");
    });
...
describe('Test20 for calculator', function() {
    ...
    it('check146', async () => {
		s = calculator.calculateNextState(s, "5");
        expect(JSON.parse(s).display).to.eql("45");
    });
    
    it('check147', async () => {
		s = calculator.calculateNextState(s, "0");
        expect(JSON.parse(s).display).to.eql("450");
    });
...
describe('Test21 for calculator', function() {
    ...
    it('check154', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("202500");
    });
});
describe('Test21 for calculator', function() {
    let s = null;
    ...
    it('check156', async () => {
		s = calculator.calculateNextState(s, "6");
        expect(JSON.parse(s).display).to.eql("36");
    });
    ...
    it('check158', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("72");
    });
    
    it('check159', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("108");
    });
});
...
describe('Test24 for calculator', function() {
    ...
    it('check178', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("32");
    });
});
...
describe('Test26 for calculator', function() {
    ...
    it('check193', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("51");
    });
    
    it('check194', async () => {
		s = calculator.calculateNextState(s, "/");
        expect(JSON.parse(s).display).to.eql("67");
    });
...
describe('Test27 for calculator', function() {
    ...
    it('check201', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("150");
    });
});
...
describe('Test29 for calculator', function() {
    ...
    it('check209', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("11");
    });
    
    it('check210', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("111");
    });
    ...
    it('check213', async () => {
		s = calculator.calculateNextState(s, "/");
        expect(JSON.parse(s).display).to.eql("37");
    });
...
describe('Test36 for calculator', function() {
    ...
    it('check244', async () => {
		s = calculator.calculateNextState(s, "6");
        expect(JSON.parse(s).display).to.eql("26");
    });
    ...
    it('check247', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("29");
    });
});
describe('Test37 for calculator', function() {
    ...
    it('check249', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("21"); //blackjack
    });
...
describe('Test38 for calculator', function() {
    ...
    it('check254', async () => {
		s = calculator.calculateNextState(s, "4");
        expect(JSON.parse(s).display).to.eql("54");
    });
...
describe('Test39 for calculator', function() {
    ...
    it('check261', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("80");
    });
    
    it('check262', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("160");
    });
});
...
describe('Test41 for calculator', function() {
    ...
    it('check275', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("211");
    });
    
    it('check276', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("2111");
    });
    
    it('check277', async () => {
		s = calculator.calculateNextState(s, "1");
        expect(JSON.parse(s).display).to.eql("21111");
    });
    ...
    it('check280', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("7037");
    });
});
...
describe('Test45 for calculator', function() {
    ...
    it('check299', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("14");
    });
    
    it('check300', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("28");
    });
});
describe('Test45 for calculator', function() {
    let s = null;
...
describe('Test48 for calculator', function() {
    ...
    it('check315', async () => {
		s = calculator.calculateNextState(s, "5");
        expect(JSON.parse(s).display).to.eql("35");
    });
    ...
    it('check318', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("70");
    });
    
    it('check319', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("140");
    });
    ...
    it('check322', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("139");
    });
});
describe('Test49 for calculator', function() {
    ...
    it('check326', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("121");
    });
});
describe('Test50 for calculator', function() {
    ...
    it('check328', async () => {
		s = calculator.calculateNextState(s, "0");
        expect(JSON.parse(s).display).to.eql("50");
    });
    ...
    it('check332', async () => {
		s = calculator.calculateNextState(s, "=");
        expect(JSON.parse(s).display).to.eql("100");  // We can sleep well at night.
    });
});
